...
def _resolver_with_condition(*, scope_type, scope_value, evaluator, projects=None, authorizations=None):
    data = datasets()
    ...
    data["knowledge_rules_data"]["rules"].append({
        ...
        "grants": [{"subject": {"type": "everyone"}, "conditions": ["registry_condition"]}],
