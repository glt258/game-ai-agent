...
| Authoritative production route is OpenCode Go with DeepSeek V4.1 Flash; V4 Flash references are historical evidence | `component.provider_boundary` | `src/agents/provider_profiles.py`, `src/agents/model_factory.py` | provider routing tests; W5-S1E-M1 contract section |
